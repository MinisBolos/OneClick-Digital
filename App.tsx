...
import { LucideLayoutDashboard, LucideLogOut, LucideSettings, LucideWand2 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleCreateProduct = async (wizardData: WizardState) => {
    ...
    try {
      ...
      console.error(error);
      alert("Falha ao gerar o produto. Por favor, verifique sua chave API e tente novamente.");
    } finally {
      ...
      case 'wizard':
        return (
          <div className="min-h-screen bg-slate-50 p-6 flex flex-col items-center">
             <div className="w-full max-w-7xl mb-8 flex items-center gap-2 text-slate-400 hover:text-slate-600 cursor-pointer" onClick={() => setCurrentView('dashboard')}>
